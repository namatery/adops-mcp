...
This is the exact walkthrough to run in your MCP client (Claude Desktop / Claude Code) against the **mock
...
# or point Claude Desktop at the server (see README)
```
...
|----------|--------|------:|------------:|----:|
| Holiday Gift Guide - Desktop | RUNNING | $63.40 | 0 | — |
| Cold Prospecting - Broad | RUNNING | $71.50 | 0 | — |
